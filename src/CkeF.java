 ...
 * @dDwiNA
 */
public class CkeF extends javax.swing.JFrame {

    /**
     * Creates new form CkeF
     */
    public CkeF() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CkeF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
